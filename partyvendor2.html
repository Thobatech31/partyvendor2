    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav1">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                    <a class="nav-link" href="index.php"><p>Home</p> <span class="sr-only">(current)</span></a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#best-features"><p>Blog</p></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="#"><p>Gallery</p></a>
                </li>


                 <li class="dropdown" id="dropdown"> 
                         <a class="dropdown-toggle" data-toggle="dropdown" href="#"><p>Vendors <span class="caret"></span></p> </a> 
            					...
            					<table>
                					...
                					<tr>
                    					...
                    					<td><p class="dropdownoptions">
                    							...
                    							<a href="photogra.html">Photographer </a><br/>
                    							<a href="vediographer.html">Vediographer</a><br/>
                    							<a>Decorators</a><br/>
                    							<a href="caterers.html">Caterers</a><br/>
                    							<a>Chocolatiers</a><br/>
                    							<a>Wedding MC</a><br/>
                    							<a>Planners</a><br/>
                    							<a>Tuxedos</a><br/>
                 ...
                 <li><a target="_blank" href="signup.html" class="btn btn-danger">Sign Up</a></li>
                    <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-default">Contact</a></li>
                

                 <li>
                    <a href="" class="btn-floating btn-tw btn-small">
                            <span class="fa-stack fa-lg" id="headericons">
            ...
            <div class="row" >
                <div class="col-md-12 col-sm-12 col-xs-12">    
                    <form class="form-inline" role="form">
                            <div class="form"> 
                                   <label for="Country" class="col-md-3 col-sm-3 col-xs-3  control-label"></label><br/>
                                        ...
                                        <select class="form-control" id="selecting" > 
                                            <option><a href="photographer.html">Photographer</a></option> 
                                            <option><a href="vediographer.html">Vediographer</a></option>
                                            <option><a href="Caterers.html">Caterers</a></option>
                        ...
                        <div class="form">
                            <label for="Country" class="col-md-3 col-sm-3 col-xs-3  control-label"></label><br/>
                            <p style="text-align:center">Choose Date & Time</p>
                            <div class='input-group date' >
                                    <input type='text' class="form-control" placeholder="Select Date & Time" id='datetimepicker1' />
                          ...
                          <div class="form-group"> 
                                <div class="col-sm-offset-2 col-sm-2"> 
                                         <a href="login.html" > <button type="button" class="btn btn-primary" id="searchbutton">SEARCH</button></a>  
                                </div> 
                        </div> 
                    </form>    
                </div>
                     ...
                     <!--Card-->
                        <div class="card" >
                            ...
                            <div class="card-block">
                                ...
                                <a class="btn btn-primary" id="categoryphotographer2" href="photogra.html">Photographer</a>
                     ...
                     <!--Card-->
                        <div class="card" >
                            ...
                            <div class="card-block">
                                ...
                                <a class="btn btn-primary" id="categorycaterers2" href="caterers.html">Caterer</a>
                     ...
                     <!--Card-->
                        <div class="card" >
                            ...
                            <div class="card-block">
                                ...
                                <a class="btn btn-primary" id="categoryphotographer2" href="vediographer.html">Vediographer</a>
                     ...
                     <!--Card-->
                        <div class="card" >
                            ...
                            <div class="card-block">
                                ...
                                <a class="btn btn-primary" id="categoryphotographer2" href="partyrental.html">Party Rentals</a>
                ...
                <div class="col-md-3 col-sm-11 col-xs-11">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <a class="btn btn-primary" id="categorycaterers2" href="venues.html">Venues</a>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-md-3 col-sm-11 col-xs-11">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <a class="btn btn-primary" id="categorycaterers2" href="artist.html">Artists</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-11 col-xs-11">
                    <div class="card">
                        <div class="card">
                            ...
                            <a class="btn btn-primary" id="categorycaterers2" href="tuxedos.html">Tuxedos</a>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-md-3 col-sm-11 col-xs-11">
                    <div class="card">
                        <div class="card">
                            ...
                            <a class="btn btn-primary" id="categoryphotographer2" href="eventplanner.html">Event Planner</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row" style="text-align: center;">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <a href="photographer.html"> <h6>Photographer</h6></a>
            </div>
            

            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="Vediographer.html"> <h6>Vediographer</h6></a>
            </div>
            ...
            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="venues.html"> <h6>Venue</h6></a>
            </div>
        </div>
<hr/>
        ...
        <div class="row" style="text-align: center;">
            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="tuxedos.html"> <h6>Tuxedos</h6></a>
            </div>
            

            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="#"> <h6>Flourist</h6></a>
            </div>

            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="partyrental.html"> <h6>Partyrental</h6></a>
            </div>

            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="eventplanner.html"> <h6>Eventplanner</h6></a>
            </div>
        </div>
<hr/>
...
<hr/>
        <div class="row" style="text-align: center;">
            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="entertainer.html"> <h6>Entertainers</h6></a>
            </div>
            ...
            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="#"> <h6>Security</h6></a>
            </div>

            <div class="col-md-3 col-sm-3 col-xs-3">
                 <a href="#"> <h6>Bands</h6></a>
            </div>
        </div>
    </div>   
...
<br>
    ...
    <div class="call-to-action">
        ...
        <ul>
            <li>
                <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">FACEBOOK</a>
                <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">TWITTER</a>
                <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">INTAGRAM</a>
                 <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">YAHOO</a>
                <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">GMAIL</a>
                 <li><a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-danger">YOUTUBE</a>
            </li>
        </ul>
    </div>
    <!--/.Call to action-->
